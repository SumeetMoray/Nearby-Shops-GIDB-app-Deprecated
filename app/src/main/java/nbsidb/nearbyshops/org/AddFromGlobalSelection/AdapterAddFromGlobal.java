...
public class AdapterAddFromGlobal extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public AdapterAddFromGlobal(List<Object> dataset, Context context, NotificationsFromAdapter notificationReceiver) {
...
//                .getNetComponent().Inject(this);
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        {
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_item_category_add_from_global,parent,false);
            return new ViewHolderItemCategory(view);
        }
        else if(viewType == VIEW_TYPE_ITEM)
        {

            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_item_add_from_global_two,parent,false);
...
//    }
    ...
    public Map<Integer, ItemCategory> getSelectedItemCategories() {
        return selectedItemCategories;
    }

    public void setSelectedItemCategories(Map<Integer, ItemCategory> selectedItemCategories) {
    ...
    public void setSelectedItems(Map<Integer, Item> selectedItems) {
