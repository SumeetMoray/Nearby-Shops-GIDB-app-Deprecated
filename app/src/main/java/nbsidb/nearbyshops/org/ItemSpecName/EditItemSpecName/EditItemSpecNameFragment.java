...
//                }
                ...
                {
                    ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Add Item Specification Name");
                }
...
//                System.out.println("Item Category ID : " + item.getItemCategoryID());
    ...
    void updateIDFieldVisibility()
    {
        ...
        else if(current_mode== MODE_UPDATE)
        {
            ...
            if(((AppCompatActivity)getActivity()).getSupportActionBar()!=null)
            {
                ((AppCompatActivity)getActivity()).getSupportActionBar().setTitle("Edit Item Specification Name");
            }
        }
    }
